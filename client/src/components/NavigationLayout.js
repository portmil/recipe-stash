    ...
    <div id="container"> 
      <nav>
        <div id='nav-bar-mobile'>
            <div class="nav-background-fill" id='nav-background-fill-left'/>
            <div class="nav-background-fill" id='nav-background-fill-right'/>
            <NavBackground id='nav-background'/>
            <NavLink to='/add-recipe'><AddButton class="nav-icon" id="add-button"/></NavLink>
            <div id='nav-bar-mobile-icons'>
                <NavLink id="home-icon" to='/home'><HomeIcon class="nav-icon"/></NavLink>
                <NavLink id="search-icon" to='/search'><SearchIcon class="nav-icon"/></NavLink>
                <NavLink id="rank-icon" to='/ranking'><RankIcon class="nav-icon"/></NavLink>
                <NavLink id="profile-icon" to='/profile'><ProfileIcon class="nav-icon"/></NavLink>
            </div>
        </div>
        <div id='nav-bar-desktop'>
            ...
            <div id='nav-bar-desktop-links'>
                ...
                <NavLink to='/add-recipe'>
                  <AddButton class="nav-icon" id="add-button"/>
                  <p>Add recipe</p>
                </NavLink>
                <NavLink id="rank-icon" to='/ranking'>
                  <RankIcon class="nav-icon"/>
                  <p>Rank recipes</p>
                </NavLink>
